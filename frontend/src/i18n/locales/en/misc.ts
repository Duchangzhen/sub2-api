export default {
  ...
  version: {
    ...
    renderModeHint: 'This service runs on Render. Merge and push the new version to GitHub main, then Render will rebuild it automatically. In-place container updates are unavailable.',
    openDeploymentRepo: 'Open deployment repository',
