export default {
  ...
  redeem: {
    ...
    purchaseGuideTitle: 'Buy a redeem code on Xianyu',
    purchaseDiscount: '5% off: API credit is charged at 95% of its listed price.',
    purchaseStep1: 'Open the Xianyu link below and purchase the credit you need.',
    purchaseStep2: 'The seller will send you an ACAIM redeem code after purchase.',
    purchaseStep3: 'Paste the code below and select Redeem to add it to your account.',
    openXianyu: 'Open Xianyu',
    redeeming: 'Redeeming...',
