export default {
  ...
  redeem: {
    ...
    purchaseGuideTitle: '闲鱼购买兑换码',
    purchaseDiscount: '充值享 95 折：购买 1 美元（1 刀）API 额度，实际付款按原价的 95% 计算。',
    purchaseStep1: '点击下方链接前往闲鱼购买所需额度。',
    purchaseStep2: '购买完成后，卖家会发送 ACAIM 兑换码。',
    purchaseStep3: '复制兑换码并粘贴到下方输入框，点击“兑换”即可到账。',
    openXianyu: '前往闲鱼购买',
    redeeming: '兑换中...',
    redeemButton: '兑换',
    redeemSuccess: '兑换成功！',
